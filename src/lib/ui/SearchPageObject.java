...
public class SearchPageObject extends MainPageObject
{
    private static final String
            ...
            SEARCH_RESULTS_BY_SUBSTRING = "//*[@resource-id='org.wikipedia:id/page_list_item_container'][2]",
    ...
    public void initSearchInput()
    {
        ...
        this.assertElementPresent(By.xpath(SEARCH_INIT_ELEMENT), "Can't find search input after clicking search init element");
    }
    ...
    {
        this.waitForElementPresent(By.xpath(SEARCH_RESULT_ELEMENT), "Can't find anything by the request ", 15);
    ...
    {
        this.waitForElementPresent(By.xpath(SEARCH_RESULTS_BY_SUBSTRING), "Can't find more than 1 article", 15);
    }

    public void clearSearchField()
    {
        this.waitForElementAndClear(By.id(SEARCH_FIELD),  "Can't find search field", 10);
    }
}
